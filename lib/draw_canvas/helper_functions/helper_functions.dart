...
Future<void> pickColorDialog(
    BuildContext context, Color selectedColor, ValueChanged<Color> onColorPicked) async {
  showDialog(
    context: context,
    builder: (_) => buildColorPickerDialog(context, selectedColor, onColorPicked),
  );
}
