...
class EmployeeIdController extends ChangeNotifier {
  ...
  EmployeeIdController() {
    companyController.text = "Your Company Name";
  ...
  Future<void> pickProfileImage(BuildContext context) async {
    try {
      ...
      if (pickedFile != null) {
        ...
        _showSuccessSnackBar(context, 'Profile image updated successfully!');
      }
    } catch (e) {
  ...
  Future<void> removeProfileImage(BuildContext context) async {
    ...
    if (confirm == true) {
      ...
      _showRemoveSnackBar(context, 'Profile photo removed successfully');
    }
  }
  ...
  Future<Uint8List?> generateIdCard(
    ...
    try {
      ...
      if (boundary == null) {
        throw Exception('Could not find ID card widget');
      }
      ...
      _showErrorSnackBar(context, 'Error generating ID card: $e');
    } finally {
